...
@media(max-width: 700px) {
  ...
  /* CTAs full width — show real Google button */
  .lp-google-wrap { width: 100%; min-height: 52px; border: none; background: transparent; }
  .lp-google-wrap > div { width: 100% !important; opacity: 1 !important; position: relative !important; }
